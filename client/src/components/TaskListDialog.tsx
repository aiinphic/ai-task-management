...
export function TaskListDialog({ open, onOpenChange, level, date, sessions, memberTasks = [] }: TaskListDialogProps) {
  if (!level) return null;

  // 篩選出選中分級的任務
  const filteredSessions = sessions.filter((session) => session.taskLevel === level);
